...
import { ManagersListPage } from './pages/managers/page';
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="customer-list" element={<Navigate to="/managers" replace />} />
        <Route path="customer-list-details" element={<Navigate to="/managers" replace />} />
      </Route>
